  ...
  async render(params = {}) {
    ...
    this.container.innerHTML = `
      <div class="aw-container">
        <!-- Master Header -->
        <div class="aw-header-row">
          <div class="aw-title-group">
            <h2>
              <i data-lucide="pen-tool" style="width:28px;height:28px;color:var(--color-primary-light);"></i>
              <span>Answer Writing & AI Evaluation Studio</span>
            </h2>
            <p>
              UPSC & State PSC Mains Answer Writing Master Suite. Practice questions, simulate real exam time pressure, type or upload answers, and receive senior examiner multi-dimensional evaluation.
            </p>
          </div>

          <div class="aw-header-actions">
            <button class="btn btn-secondary btn-sm" onclick="answerWritingView.openAiQuestionModal()" title="Generate exam question via AI">
              <i data-lucide="sparkles" style="color:var(--color-gold);"></i>
              <span>Generate Question with AI</span>
            </button>
            <button class="btn btn-secondary btn-sm" onclick="answerWritingView.openManualQuestionModal()" title="Enter your own question">
